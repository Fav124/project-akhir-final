            ...
            @forelse($logs as $log)
                <tr class="hover:bg-slate-50 transition-colors group">
                    ...
                    <td class="px-6 py-4 text-right">
                        <a href="{{ route('admin.activity.show', $log->id) }}" title="Detail"
                            class="p-1 hover:bg-blue-50 rounded text-blue-500 transition-colors border border-transparent hover:border-blue-100 inline-flex items-center justify-center opacity-0 group-hover:opacity-100">
